...
$target_dir = __DIR__ . "/sds_image_uploads_schedule/"; 
...
$new_server_file = "sds_image_uploads_schedule/img_" . date("Ymdhis") . round(microtime(true) * 1000) . "." . $imageFileType;
    ...
    else 
    {
        if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $new_server_file)) 
        {
			...
			if($device_id > 0)
			{
				...
				$sql = "INSERT INTO sds_t_device_display_schedule (deviceid, url,start_time,end_time) VALUES (" . $device_id . ", '" . $new_server_file . "','" . $from_time . "','" . $to_time . "')";
				echo "<br>".$sql;
