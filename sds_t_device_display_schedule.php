...
<body>
	<center>
	<h2 style="font-family:verdana" "font-size:30px">SCHEDULE UPLOAD</h2>
	</center>
...
<form action="sds_image_uploads _schedule.php" method="post" enctype="multipart/form-data" 
      style="width: 420px; margin: 100px auto; padding: 30px; 
...
?>
  ...
  <p style="font-size: 12px; color: #555; margin-top: 15px;">
    ...
    <label for="from">Select from time:</label>
	<input type="time" id="from_time" name="from_time"> <br>

	<label for="to">Select to time:</label>
